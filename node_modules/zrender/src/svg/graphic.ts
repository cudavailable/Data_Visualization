...
} from 'zrender/src/svg/helper';
import Path, { PathStyleProps } from 'zrender/src/graphic/Path';
import ZRImage, { ImageStyleProps } from 'zrender/src/graphic/Image';
import { getLineHeight } from 'zrender/src/contain/text';
import TSpan, { TSpanStyleProps } from 'zrender/src/graphic/TSpan';
import SVGPathRebuilder from 'zrender/src/svg/SVGPathRebuilder';
import mapStyleToAttrs from 'zrender/src/svg/mapStyleToAttrs';
import { SVGVNodeAttrs, createVNode, SVGVNode, vNodeToString, BrushScope, META_DATA_PREFIX } from 'zrender/src/svg/core';
import { MatrixArray } from 'zrender/src/core/matrix';
import Displayable from 'zrender/src/graphic/Displayable';
import { assert, clone, isFunction, isString, logError, map, retrieve2 } from 'zrender/src/core/util';
import Polyline from 'zrender/src/graphic/shape/Polyline';
import Polygon from 'zrender/src/graphic/shape/Polygon';
import { GradientObject } from 'zrender/src/graphic/Gradient';
import { ImagePatternObject, SVGPatternObject } from 'zrender/src/graphic/Pattern';
import { createOrUpdateImage } from 'zrender/src/graphic/helper/image';
import { ImageLike } from 'zrender/src/core/types';
import { createCSSAnimation } from 'zrender/src/svg/cssAnimation';
import { hasSeparateFont, parseFontSize } from 'zrender/src/graphic/Text';
import { DEFAULT_FONT, DEFAULT_FONT_FAMILY } from 'zrender/src/core/platform';
import { createCSSEmphasis } from 'zrender/src/svg/cssEmphasis';
import { getElementSSRData } from 'zrender/src/zrender';
