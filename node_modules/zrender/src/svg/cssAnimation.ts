...
import { SVGVNodeAttrs, BrushScope, createBrushScope} from 'zrender/src/svg/core';
import Path from 'zrender/src/graphic/Path';
import SVGPathRebuilder from 'zrender/src/svg/SVGPathRebuilder';
import PathProxy from 'zrender/src/core/PathProxy';
import { getPathPrecision, getSRTTransformString } from 'zrender/src/svg/helper';
import { each, extend, filter, isNumber, isString, keys } from 'zrender/src/core/util';
import Animator from 'zrender/src/animation/Animator';
import CompoundPath from 'zrender/src/graphic/CompoundPath';
import { AnimationEasing } from 'zrender/src/animation/easing';
import { createCubicEasingFunc } from 'zrender/src/animation/cubicEasing';
import { getClassId } from 'zrender/src/svg/cssClassId';
