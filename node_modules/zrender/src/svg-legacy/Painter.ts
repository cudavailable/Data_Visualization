...
import {createElement, SVGNS, XLINKNS, XMLNS} from 'zrender/src/svg/core';
import { normalizeColor } from 'zrender/src/svg/helper';
...
import GradientManager from 'zrender/src/svg-legacy/helper/GradientManager';
import PatternManager from 'zrender/src/svg-legacy/helper/PatternManager';
import ClippathManager, {hasClipPath} from 'zrender/src/svg-legacy/helper/ClippathManager';
import ShadowManager from 'zrender/src/svg-legacy/helper/ShadowManager';
import {
    path as svgPath,
    image as svgImage,
    text as svgText,
    SVGProxy
} from 'zrender/src/svg-legacy/graphic';
