...
import * as pathContain from 'zrender/src/contain/path';
import { PatternObject } from 'zrender/src/graphic/Pattern';
import { Dictionary, PropType, MapToType } from 'zrender/src/core/types';
...
import { defaults, keys, extend, clone, isString, createObject } from 'zrender/src/core/util';
import Animator from 'zrender/src/animation/Animator';
import { lum } from 'zrender/src/tool/color';
import { DARK_LABEL_COLOR, LIGHT_LABEL_COLOR, DARK_MODE_THRESHOLD, LIGHTER_LABEL_COLOR } from 'zrender/src/config';
import { REDRAW_BIT, SHAPE_CHANGED_BIT, STYLE_CHANGED_BIT } from 'zrender/src/graphic/constants';
import { TRANSFORMABLE_PROPS } from 'zrender/src/core/Transformable';
