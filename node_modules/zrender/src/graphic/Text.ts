 ...
 */
import { TextAlign, TextVerticalAlign, ImageLike, Dictionary, MapToType, FontWeight, FontStyle } from 'zrender/src/core/types';
import { parseRichText, parsePlainText } from 'zrender/src/graphic/helper/parseText';
import TSpan, { TSpanStyleProps } from 'zrender/src/graphic/TSpan';
import { retrieve2, each, normalizeCssArray, trim, retrieve3, extend, keys, defaults } from 'zrender/src/core/util';
import { adjustTextX, adjustTextY } from 'zrender/src/contain/text';
...
} from 'zrender/src/graphic/Displayable';
import { ZRenderType } from 'zrender/src/zrender';
import Animator from 'zrender/src/animation/Animator';
import Transformable from 'zrender/src/core/Transformable';
import { ElementCommonState } from 'zrender/src/Element';
import { GroupLike } from 'zrender/src/graphic/Group';
import { DEFAULT_FONT, DEFAULT_FONT_SIZE } from 'zrender/src/core/platform';
