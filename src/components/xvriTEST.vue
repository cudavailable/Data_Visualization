...
export default {
  ...
  var dataMap = {
    ...
    let option = {
      ...
      options: [
        { title: { text: '2013年全国工业产值' }, series: { data: buildSunburstData('2013') } },
        { title: { text: '2014年全国工业产值' }, series: { data: buildSunburstData('2014') } },
        { title: { text: '2015年全国工业产值' }, series: { data: buildSunburstData('2015') } },
        { title: { text: '2016年全国工业产值' }, series: { data: buildSunburstData('2016') } },
        { title: { text: '2017年全国工业产值' }, series: { data: buildSunburstData('2017') } },
        { title: { text: '2018年全国工业产值' }, series: { data: buildSunburstData('2018') } },
        { title: { text: '2019年全国工业产值' }, series: { data: buildSunburstData('2019') } },
        { title: { text: '2020年全国工业产值' }, series: { data: buildSunburstData('2020') } },
        { title: { text: '2021年全国工业产值' }, series: { data: buildSunburstData('2021') } },
        { title: { text: '2022年全国工业产值' }, series: { data: buildSunburstData('2022') } },
      ]
    };
